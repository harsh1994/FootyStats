...
$playerinfo = oci_parse($conn,'SELECT player.name, outfieldplayer.position, player.nationality,player.goals,player.age,outfieldplayer.rating,outfieldplayer.pace,outfieldplayer.shooting,outfieldplayer.passing,outfieldplayer.dribbling,outfieldplayer.defending,outfieldplayer.physical,outfieldplayer.heading,outfieldplayer.stamina,outfieldplayer.strength,outfieldplayer.aggression,outfieldplayer.interceptions FROM player,OUTFIELD_PLAYER WHERE player.name=outfieldplayer.name AND player.name=:nm');
